...
const { sendMail } = require("../../../api-gateway/utils/Emails");
const { generateOTP } = require("../../../api-gateway/utils/GenerateOtp");
const Otp = require("../models/OTP");
const { sanitizeUser } = require("../../../api-gateway/utils/SanitizeUser");
const { generateToken } = require("../../../api-gateway/utils/GenerateToken");
