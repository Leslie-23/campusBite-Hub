const bcrypt = require("bcryptjs"); //need to install annd `npm init`

const { sendMail } = require("../utils/Emails"); //need to create
const { generateOTP } = require("../utils/GenerateOtp"); //need to create
const { sanitizeUser } = require("../utils/SanitizeUser"); // need to create
const { generateToken } = require("../utils/GenerateToken"); // need to create

const User = require("../models/User"); // not yet done
const Otp = require("../models/OTP"); // needed to create
const PasswordResetToken = require("../models/PasswordResetToken"); // need to create

// without the above comments in place app will not run. --URGENT
  ...
  try {
    ...
    await sendMail(
      ...
      `<p>Dear ${isExistingUser.name},
        ...
        We received a request to reset the password for your CampusBite account. If you initiated this request, please use the following link to reset your password:</p>
